                ...
                if NegNum == True:
                    ...
                    if floatNum != '':
                        if 'e' in floatNum:
                            ...
                            # print(f'floatNum.split("e")[1] == {float(floatNum.split("e")[1])}')
                            floatNum=float(floatNum.split('e')[0])*10**(float(floatNum.split('e')[1]))
...
def main():
    ...
    str_math=r'0.0+[(0.0000*cos{(1.0*3.9270*1.0)})+(0.0000*cos{(3.0*3.9270*1.0)})+(0.0000*cos{(5.0*3.9270*1.0)})]+[(63.6620*sin{(1.0*3.9270*1.0)})+(21.2207*sin{(3.0*3.9270*1.0)})+(12.7324*sin{(5.0*3.9270*1.0)})]'
